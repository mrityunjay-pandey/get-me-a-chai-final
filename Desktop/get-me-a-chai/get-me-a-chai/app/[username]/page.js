        ...
        <div className="payment flex gap-3 w-[80%] mt-11">
          ...
          <div className="makePayment w-1/2 bg-slate-900 p-10 rounded-lg text-white">
            ...
            <div className="flex gap-2 flex-col">
              ...
              <button
                type="button"
                class="w-full text-white bg-gradient-to-br from-purple-600 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
              >
                Pay
              </button>
            </div>
