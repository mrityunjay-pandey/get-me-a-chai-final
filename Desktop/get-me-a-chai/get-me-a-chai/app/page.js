  ...
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh] px-5 md:px-0 text-xs md:text-base">
        <div className="font-bold md:text-5xl flex gap-6 md:gap-20 justify-center items-center  text-3xl">
          Buy Me a Chai
          <span>
            <img className="invertImge" src="/tea.gif" width={88} alt="" />
          </span>
        </div>
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
        ...
        <iframe
          ...
          src="https://www.youtube.com/embed/Yi0u1bz6xiw?si=NJ-cutaCwiPlMA4P"
